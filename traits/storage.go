...
// Storage creates the storage trait definition.
// This trait adds storages on K8s pod for workloads.
// Uses RawCUE for the template content as it requires:
// - Complex list comprehensions for volumes, volumeMounts, env, volumeDevices
// - De-duplication logic for volumes array
// - Multiple conditional outputs (PVC, ConfigMap, Secret)
// - Nested conditionals for mountPath vs mountToEnv
func Storage() *defkit.TraitDefinition {
	return defkit.NewTrait("storage").
