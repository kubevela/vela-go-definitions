...
// Nocalhost creates the nocalhost trait definition.
// This trait configures nocalhost develop settings.
// Uses RawCUE for the template content as it requires:
// - JSON marshaling (encoding/json import)
// - Complex conditional image mapping based on language
// - Deep nested struct with many conditional fields
func Nocalhost() *defkit.TraitDefinition {
	return defkit.NewTrait("nocalhost").
