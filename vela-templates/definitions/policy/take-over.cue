...
template: {
	...
	parameter: {
		// +usage=Specify the list of rules to control take over strategy at resource level. The selected resource will be able to be taken over by the current application when the resource belongs to no one.
		rules?: [...#PolicyRule]
	}
}
